...
func update_character_avatars() -> void:
	...
	if real_player.character_avatar_visible:
		%PlayerAbilityAvatar.texture = real_player.current_character_card.avatar_texture
	if opponent.character_avatar_visible:
		%OpponentAbilityAvatar.texture = opponent.current_character_card.avatar_texture
